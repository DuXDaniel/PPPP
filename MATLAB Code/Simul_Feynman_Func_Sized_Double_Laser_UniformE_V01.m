function [voxel_grid_cumulative_phase_data] = Simul_Feynman_Func_Sized_UniformE_V01(beam_waist, laser_res, pulse_energy)
        ...
        for cur_slice = 1:slice_granularity
            ...
            for m = 1:voxel_granularity
                for n = 1:voxel_granularity
                    ...
                    x_func = @(t) y_func(t).*voxel_grid_slope_x_data(m,n) + x_drift(xin);
                    z_func = @(t) y_func(t).*voxel_grid_slope_z_data(m,n) + z_drift(zin);
