function [final_phase_data, voxel_grid_phase_data] = Simul_Feynman_Func_V01(beam_waist, laser_res, e_res, pulse_energy)
...
integral_bound = gauss_limit*max([sig_ebeam, sig_las]);
