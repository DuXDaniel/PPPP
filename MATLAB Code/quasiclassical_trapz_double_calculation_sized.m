function [voxel_grid_phase_data_unpacked] = quasiclassical_trapz_calculation_sized(num_voxels,init_y_vals,x_slopes,z_slopes,t_range,norm_factor_array,laser,norm_func,beta,c,lambda,theta,integral_bound,t_bounds,vel,z_drift,x_drift,xin,zin)
...
parfor cur_voxel = 1:num_voxels
    ...
    x_vals = y_vals.*x_slopes_gpu(cur_voxel) + x_shift;
    z_vals = y_vals.*z_slopes_gpu(cur_voxel) + z_shift;
