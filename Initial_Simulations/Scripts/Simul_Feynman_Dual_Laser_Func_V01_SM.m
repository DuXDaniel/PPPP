function [final_phase_data, voxel_grid_phase_data] = Simul_Feynman_Dual_Laser_Func_V01_SM(beam_waist, laser_res, e_res, pulse_energy)
...
assignin('base','sig_ratios',sig_ratios);
assignin('base','weights',weights);
assignin('base','t_bounds',t_bounds);
...
assignin('base','norm_factor_array',norm_factor_array);
...
assignin('base','voxel_grid_y_data',voxel_grid_y_data);
assignin('base','voxel_grid_slope_x_data',voxel_grid_slope_x_data);
assignin('base','voxel_grid_slope_z_data',voxel_grid_y_data);
...
filler_data = zeros(voxel_granularity,voxel_granularity,slice_granularity);
for cur_voxel = 0:num_voxels-1
    ...
    filler_data(m,n,cur_slice) = 1;
end
assignin('base','init_y_vals',init_y_vals);
assignin('base','x_slopes',x_slopes);
assignin('base','z_slopes',z_slopes);
assignin('base','filler_data',filler_data);
...
parfor cur_voxel = 1:num_voxels
    ...
    norm_factor_2 = @(t) interp1(t_range,norm_factor_array_2,t);
...
assignin('base','voxel_grid_phase_data_unpacked',voxel_grid_phase_data_unpacked);
