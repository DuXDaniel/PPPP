...
for cur_slice = round(voxel_granularity/2)%1:voxel_granularity
    ...
    for m = 1:voxel_granularity
        parfor n = 1:voxel_granularity
            ...
            voxel_grid_phase_data(m,n,cur_slice) = artificial_factor.*integral(@(t) full_func(t), -integral_bound, integral_bound);
