function [final_phase_data, voxel_grid_phase_data] = Quasiclassical_Func_V01_SM_trapz(beam_waist, laser_res, e_res, prefactor)
...
voxel_grid_phase_data_unpacked = quasiclassical_trapz_calculation(num_voxels,init_y_vals,x_slopes,z_slopes,t_range_extended,norm_factor_array,laser,norm_func,beta,c,lambda,theta,integral_bound,t_bounds,vel);
