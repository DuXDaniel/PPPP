...
%         save(assign_var_name,'phase','slices');
        ...
        [phase, slices] = Quasiclassical_Func_Double_Laser_V01_SM_VarVox(las_width_int, las_res_int, e_res_int, las_pulse_int, voxel_gran_length(i)^2, slice_gran_length(j)^2,2000);
