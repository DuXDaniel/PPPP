function [voxel_grid_cumulative_phase_data] = Simul_Feynman_Func_Sized_V01_SM(beam_waist, laser_res, e_res, pulse_energy)
...
assignin('base','voxel_xz_grid_weights',voxel_xz_grid_weights);
