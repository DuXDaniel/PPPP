function [final_phase_data, voxel_grid_phase_data] = Quasiclassical_Func_V01(beam_waist, laser_res, e_res, prefactor)
...
%
%     test_pixels(slice_inc) = artificial_factor.*integral(@(t) full_func(t), cur_t_center-integral_bound, cur_t_center+integral_bound, 'Waypoints', integral_waypoints);
% end
%
...
%         test_grid_bound_1(m,n) = artificial_factor.*integral(@(t) full_func(t), cur_t_center-integral_bound, cur_t_center+integral_bound, 'Waypoints', integral_waypoints);
...
%         integral_waypoints = [-abs(voxel_grid_y_data(1,1,slice_test))/vel,0,abs(voxel_grid_y_data(1,1,slice_test))/vel];
%
%         test_grid_bound_2(m,n) = artificial_factor.*integral(@(t) full_func(t), cur_t_center-integral_bound, cur_t_center+integral_bound, 'Waypoints', integral_waypoints);
%         %             if (voxel_grid_phase_data(m,n,cur_slice) ~= 0)
%         %                 voxel_grid_phase_data(m,n,cur_slice)
%         %             end
%     end
...
%             integral_waypoints = [-abs(voxel_grid_y_data(1,1,slice_test))/vel,0,abs(voxel_grid_y_data(1,1,slice_test))/vel];
%
%             test_grid(m,n) = artificial_factor.*integral(@(t) full_func(t), cur_t_center - integral_bound, cur_t_center + integral_bound, 'Waypoints', integral_waypoints);
%             %             if (voxel_grid_phase_data(m,n,cur_slice) ~= 0)
%             %                 voxel_grid_phase_data(m,n,cur_slice)
%             %             end
%         end
...
%     if (max(max(voxel_grid_phase_data(:,:,cur_slice))) > 0)
