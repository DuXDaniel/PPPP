function [final_phase_data] = Simul_Script_Test_V3_Func(beam_waist, laser_res, e_res, pulse_energy)
...
laser_sum = @(t) integral2(@(x,y) 2.*pi.*x.*laser(x,y,t), 0, Inf, -Inf, Inf);
...
for cur_slice = 1:voxel_granularity
    ...
    for m = 1:voxel_granularity
        parfor n = 1:voxel_granularity
            ...
            voxel_grid_phase_data(m,n,cur_slice) = integral(@(t) full_func(t), -Inf, Inf,'ArrayValued',true);
