function [voxel_grid_cumulative_phase_data] = Quasiclassical_Func_Sized_Double_Laser_UniformE_V01_SM_trapz(beam_waist, laser_res, e_res, prefactor)
...
for zin = 1:length(z_drift)
    ...
    for xin = 1:length(x_drift)
        ...
        voxel_grid_phase_data_unpacked = quasiclassical_trapz_double_calculation_sized(num_voxels,init_y_vals,x_slopes,z_slopes,t_range_extended,norm_factor_array,laser,norm_func,beta,c,lambda,theta,integral_bound,t_bounds,vel,z_drift,x_drift,xin,zin);
