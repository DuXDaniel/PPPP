...
assign_var_name = 'Simul_Feynman_Func_Sized_doulas_10pslas_10pse_100um_1uJ_SM';
...
if ~isnan(phase)
    ...
    pbaspect([1 1 1]);
    print(assign_var_name,'-dpng','-r600')
    close(f);
    
end

assign_var_name = 'Simul_Feynman_Func_Sized_doulas_10pslas_10pse_100um_5uJ_SM';
load(assign_var_name);
...
assign_var_name = 'Simul_Feynman_Func_Sized_doulas_10pslas_10pse_100um_10uJ_SM';
load(assign_var_name);
...
assign_var_name = 'Simul_Feynman_Func_Sized_doulas_10pslas_10pse_100um_250nJ_SM';
load(assign_var_name);
...
assign_var_name = 'Simul_Feynman_Func_Sized_doulas_10pslas_10pse_100um_500nJ_SM';
load(assign_var_name);
