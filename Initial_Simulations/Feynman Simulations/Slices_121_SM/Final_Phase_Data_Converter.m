function [final_phase_data, t_range] = Final_Phase_Data_Converter(beam_waist, laser_res, e_res, prefactor, voxel_grid_phase_data)
...
t_range = (t_bounds(2:end) + t_bounds(1:end-1))/2;
